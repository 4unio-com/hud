...
const gchar *           hud_menu_model_collector_get_app_id             (HudMenuModelCollector * collector);

const gchar *           hud_menu_model_collector_get_app_icon           (HudMenuModelCollector * collector);
