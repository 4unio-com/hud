...
#ifndef __HUD_ENUM_TYPES_H__
#define __HUD_ENUM_TYPES_H__
...
/**
	HUD_TYPE_CLIENT_QUERY_TOOLBAR_ITEMS:

	Gets the #GType value for the type associated with the
	#HudClientQueryToolbarItems enumerated type.
*/
#define HUD_TYPE_CLIENT_QUERY_TOOLBAR_ITEMS (hud_client_query_toolbar_items_get_type())


G_END_DECLS

#endif /* __HUD_ENUM_TYPES_H__ */
